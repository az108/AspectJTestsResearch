...
public class MainAspectJava {
    ...
    @Pointcut("execution(java.nio.file.Path org.example.Main.getPath(..)) && args(first, more)")
    public void getPathMethod(String first, String... more) {}

    // Pointcut for Files.write method
    @Pointcut("(call(* java.io.FileOutputStream.write(..)) || call(* java.nio.file.Files.write(..))) && within(org.example..*)")
